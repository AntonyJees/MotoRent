...
<body>
  ...
  <div class="card-body">
  <div class="row">
    <h2 class="card-title col-md-6">${v.vehicleName}${v.model}</h2>
    <h4 class="card-title col-md-6">${v.cost}</h4>
    <h4 class="card-title col-md-6">Distance Travelled:${v.distance}</h4>
