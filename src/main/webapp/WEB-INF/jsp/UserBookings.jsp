								...
								<div class="card" style="max-width: 540px;">
									<div class="row g-0">
										...
										<div class="col-md-5 mt-2">
											<div class="card-body">
												<h5 class="card-title">${v.addvehicle.companyName }</h5>
												<h4 class="card-text">${v.addvehicle.vehicleName }</h4>
												<h5 class="card-text">Total:${v.price}</h5>
												<a href="cancelBooking/${v.id}"
													class="btn btn-primary stretched-link">Cancel Booking</a>
											</div>
										</div>
									</div>
								</div>
